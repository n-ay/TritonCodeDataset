# Triton kernels for YituTech/conv-bert-base
...
def triton_per_fused_add_embedding_native_layer_norm_0(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, in_ptr6, in_ptr7, xnumel, r0_numel):
    ...
    tmp8 = tl.full([R0_BLOCK], 512, tl.int32)
    tmp9 = tmp7 + tmp8
    tmp10 = tmp7 < 0
...
def triton_poi_fused_mul_3(in_out_ptr0, in_ptr0, in_ptr1, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp3 = tl.load(in_out_ptr0 + (x1 + 64*y0), xmask & ymask, eviction_policy='evict_last')
    tmp2 = tmp0 + tmp1
    tmp4 = tmp2 * tmp3
    tl.debug_barrier()
    tl.store(in_out_ptr0 + (x1 + 64*y0), tmp4, xmask & ymask)
''', device_str='cuda')
...
def triton_poi_fused_im2col_5(in_ptr0, in_ptr1, out_ptr0, ynumel, xnumel, YBLOCK : tl.constexpr, XBLOCK : tl.constexpr):
    ...
    tmp4 = tmp0 < tmp3
    tmp5 = tmp2 & tmp4
    tmp6 = tl.load(in_ptr0 + ((-256) + y0 + 64*x1 + 64*x2), tmp5 & xmask & ymask, eviction_policy='evict_last', other=0.0)
...
def triton_poi_fused_cat_6(in_ptr0, in_ptr1, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    tmp4 = tmp0 < tmp3
    tmp5 = tl.load(in_ptr0 + (x0 + 64*x2), tmp4, eviction_policy='evict_last', other=0.0)
    tmp6 = tmp0 >= tmp3
    tmp7 = tl.full([1], 2, tl.int64)
    tmp8 = tmp0 < tmp7
    tmp9 = tl.load(in_ptr1 + (x0 + 64*x2), tmp6, eviction_policy='evict_last', other=0.0)
...
def triton_per_fused_add_native_layer_norm_7(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, r0_numel, XBLOCK : tl.constexpr):
    ...
    tmp29 = tmp27 * tmp28
    tmp31 = tmp29 + tmp30
    tl.store(in_out_ptr0 + (r0_1 + 128*x0), tmp31, xmask)
''', device_str='cuda')
...
# kernel path: /tmp/torchinductor_root/ze/czexocumevqcb2ld3e4kx4vjuvkyzjvcblyk3lr6hwrvl34db42q.py
# Topologically Sorted Source Nodes: [x], Original ATen: [aten.convolution]
# Source node to ATen node mapping:
#   x => convolution
# Graph fragment:
#   %convolution : [num_users=1] = call_function[target=torch.ops.aten.convolution.default](args = (%permute_3, %arg15_1, None, [1], [4], [1], False, [0], 128), kwargs = {})
triton_poi_fused_convolution_2 = async_compile.triton('triton_poi_fused_convolution_2', '''
import triton
import triton.language as tl
...
# kernel path: /tmp/torchinductor_root/jx/cjxz57jn6emnpgi6aqbnvyqb456fpmjghlgezz3f7ii5wf46sype.py
...
#   %sub_tensor_1 : [num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%view_13, %getitem_14), kwargs = {})
#   %exp_default_1 : [num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%sub_tensor_1,), kwargs = {})
#   %div : [num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%exp_default_1, %getitem_15), kwargs = {})
triton_per_fused__softmax_exp_prepare_softmax_online_sub_4 = async_compile.triton('triton_per_fused__softmax_exp_prepare_softmax_online_sub_4', '''
import triton
import triton.language as tl
...
# kernel path: /tmp/torchinductor_root/eu/ceuh33za2remiedsd4qlmdzog54jfmx35ij5nzy2vh6lbxgxayuo.py
...
# kernel path: /tmp/torchinductor_root/ml/cmllwow7rqsspk4ow7s3qdk3lxvvgtsxqxutvvm7vsiiayu6kq3g.py
...
# kernel path: /tmp/torchinductor_root/ii/ciitiwpdwivhfn2ljby575fugs6pfmuuj3x2a6j6fjmvc2vexo5n.py
...
# kernel path: /tmp/torchinductor_root/ii/ciilc5j4h4ya565mrcuidap25smodoqq2prf6uxesiz5ffz7htca.py
...
def call(args):
    ...
    assert_size_stride(arg38_1, (128, 1, 9), (9, 9, 1))
    assert_size_stride(arg39_1, (64, 128, 1), (128, 1, 1))
    assert_size_stride(arg40_1, (64, 1), (1, 1))
    assert_size_stride(arg41_1, (64, 128), (128, 1))
    assert_size_stride(arg42_1, (64, ), (1, ))
    assert_size_stride(arg43_1, (9, 64), (64, 1))
    ...
    assert_size_stride(arg51_1, (256, 128), (128, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        extern_kernels.addmm(arg10_1, reinterpret_tensor(buf4, (32, 768), (768, 1), 0), reinterpret_tensor(arg9_1, (768, 128), (1, 768), 0), alpha=1, beta=1, out=buf5)
        del arg10_1
        del arg9_1
        del buf4
        ...
        extern_kernels.addmm(arg19_1, buf5, reinterpret_tensor(arg18_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf6)
        del arg18_1
        del arg19_1
        ...
        extern_kernels.addmm(arg12_1, buf5, reinterpret_tensor(arg11_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf7)
        del arg11_1
        del arg12_1
        ...
        extern_kernels.addmm(arg14_1, buf5, reinterpret_tensor(arg13_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf8)
        del arg13_1
        del arg14_1
        ...
        del arg1_1
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf10 = torch.ops.aten._scaled_dot_product_efficient_attention.default(reinterpret_tensor(buf6, (1, 1, 32, 64), (2048, 64, 64, 1), 0), reinterpret_tensor(buf7, (1, 1, 32, 64), (2048, 64, 64, 1), 0), reinterpret_tensor(buf8, (1, 1, 32, 64), (2048, 64, 64, 1), 0), buf9, False)
        del buf7
        del buf9
        buf11 = buf10[0]
        assert_size_stride(buf11, (1, 1, 32, 64), (2048, 64, 64, 1), 'torch.ops.aten._scaled_dot_product_efficient_attention.default')
        ...
        extern_kernels.mm(buf5, reinterpret_tensor(arg22_1, (128, 64), (1, 128), 0), out=buf15)
        del arg22_1
        buf16 = empty_strided_cuda((1, 128, 32), (4096, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [x], Original ATen: [aten.convolution]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_2.run(buf5, buf16, 128, 32, stream=stream0)
        # Topologically Sorted Source Nodes: [x], Original ATen: [aten.convolution]
        buf17 = extern_kernels.convolution(buf16, arg15_1, stride=(1,), padding=(4,), dilation=(1,), transposed=False, output_padding=(0,), groups=128, bias=None)
        assert_size_stride(buf17, (1, 128, 32), (4096, 32, 1), 'torch.ops.aten.convolution.default')
        del arg15_1
        ...
        assert_size_stride(buf18, (1, 64, 32), (2048, 32, 1), 'torch.ops.aten.convolution.default')
        del arg16_1
        buf19 = reinterpret_tensor(buf6, (1, 32, 64), (2048, 64, 1), 0); del buf6  # reuse
        # Topologically Sorted Source Nodes: [conv_attn_layer], Original ATen: [aten.mul]
        stream0 = get_raw_stream(0)
        triton_poi_fused_mul_3.run(buf19, buf18, arg17_1, 32, 64, stream=stream0)
        del arg17_1
        del buf18
        buf20 = empty_strided_cuda((32, 9), (9, 1), torch.float32)
        # Topologically Sorted Source Nodes: [conv_kernel_layer], Original ATen: [aten.mm]
        extern_kernels.mm(reinterpret_tensor(buf19, (32, 64), (64, 1), 0), reinterpret_tensor(arg20_1, (64, 9), (1, 64), 0), out=buf20)
        del arg20_1
        ...
        del arg21_1
        buf23 = empty_strided_cuda((1, 64, 9, 32, 1, 1), (18432, 288, 32, 1, 1, 1), torch.float32)
        # Topologically Sorted Source Nodes: [conv_out_layer_3], Original ATen: [aten.im2col]
        stream0 = get_raw_stream(0)
        triton_poi_fused_im2col_5.run(buf15, arg23_1, buf23, 64, 288, stream=stream0)
        del arg23_1
        buf25 = reinterpret_tensor(buf15, (32, 64, 1), (64, 1, 1), 0); del buf15  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf23, (32, 64, 9), (1, 288, 32), 0), buf24, out=buf25)
        buf26 = reinterpret_tensor(buf17, (1, 32, 2, 64), (4096, 128, 64, 1), 0); del buf17  # reuse
        # Topologically Sorted Source Nodes: [context_layer_2], Original ATen: [aten.cat]
        stream0 = get_raw_stream(0)
        triton_poi_fused_cat_6.run(buf11, buf25, buf26, 4096, stream=stream0)
        buf27 = reinterpret_tensor(buf16, (32, 128), (128, 1), 0); del buf16  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.addmm]
        extern_kernels.mm(reinterpret_tensor(buf26, (32, 128), (128, 1), 0), reinterpret_tensor(arg24_1, (128, 128), (1, 128), 0), out=buf27)
        del arg24_1
        del buf26
        buf31 = reinterpret_tensor(buf27, (1, 32, 128), (4096, 128, 1), 0); del buf27  # reuse
        # Topologically Sorted Source Nodes: [add_3, hidden_states_3], Original ATen: [aten.add, aten.native_layer_norm]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_native_layer_norm_7.run(buf31, arg25_1, buf5, arg26_1, arg27_1, 32, 128, stream=stream0)
        del arg25_1
        del arg26_1
        del arg27_1
        buf32 = empty_strided_cuda((32, 256), (256, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.addmm]
        extern_kernels.mm(reinterpret_tensor(buf31, (32, 128), (128, 1), 0), reinterpret_tensor(arg28_1, (128, 256), (1, 128), 0), out=buf32)
        del arg28_1
        buf33 = reinterpret_tensor(buf32, (1, 32, 256), (8192, 256, 1), 0); del buf32  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_5], Original ATen: [aten.gelu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_gelu_8.run(buf33, arg29_1, 8192, stream=stream0)
        del arg29_1
        buf34 = buf5; del buf5  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.addmm]
        extern_kernels.mm(reinterpret_tensor(buf33, (32, 256), (256, 1), 0), reinterpret_tensor(arg30_1, (256, 128), (1, 256), 0), out=buf34)
        del arg30_1
        buf38 = reinterpret_tensor(buf34, (1, 32, 128), (4096, 128, 1), 0); del buf34  # reuse
        # Topologically Sorted Source Nodes: [add_4, hidden_states_8], Original ATen: [aten.add, aten.native_layer_norm]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_native_layer_norm_7.run(buf38, arg31_1, buf31, arg32_1, arg33_1, 32, 128, stream=stream0)
        del arg31_1
        del arg32_1
        del arg33_1
        buf39 = reinterpret_tensor(buf25, (32, 64), (64, 1), 0); del buf25  # reuse
        # Topologically Sorted Source Nodes: [mixed_query_layer_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg42_1, reinterpret_tensor(buf38, (32, 128), (128, 1), 0), reinterpret_tensor(arg41_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf39)
        del arg41_1
        del arg42_1
        buf40 = reinterpret_tensor(buf11, (32, 64), (64, 1), 0); del buf11  # reuse
        # Topologically Sorted Source Nodes: [mixed_key_layer_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg35_1, reinterpret_tensor(buf38, (32, 128), (128, 1), 0), reinterpret_tensor(arg34_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf40)
        del arg34_1
        del arg35_1
        buf41 = reinterpret_tensor(buf19, (32, 64), (64, 1), 0); del buf19  # reuse
        # Topologically Sorted Source Nodes: [mixed_value_layer_1], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg37_1, reinterpret_tensor(buf38, (32, 128), (128, 1), 0), reinterpret_tensor(arg36_1, (128, 64), (1, 128), 0), alpha=1, beta=1, out=buf41)
        del arg36_1
        del arg37_1
        # Topologically Sorted Source Nodes: [], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf43 = torch.ops.aten._scaled_dot_product_efficient_attention.default(reinterpret_tensor(buf39, (1, 1, 32, 64), (2048, 64, 64, 1), 0), reinterpret_tensor(buf40, (1, 1, 32, 64), (2048, 64, 64, 1), 0), reinterpret_tensor(buf41, (1, 1, 32, 64), (2048, 64, 64, 1), 0), buf42, False)
        del buf40
        del buf42
        buf44 = buf43[0]
        assert_size_stride(buf44, (1, 1, 32, 64), (2048, 64, 64, 1), 'torch.ops.aten._scaled_dot_product_efficient_attention.default')
        assert_alignment(buf44, 16, 'torch.ops.aten._scaled_dot_product_efficient_attention.default')
        del buf43
        buf48 = buf41; del buf41  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.addmm]
        extern_kernels.mm(reinterpret_tensor(buf38, (32, 128), (128, 1), 0), reinterpret_tensor(arg45_1, (128, 64), (1, 128), 0), out=buf48)
        del arg45_1
        buf49 = reinterpret_tensor(buf31, (1, 128, 32), (4096, 32, 1), 0); del buf31  # reuse
        # Topologically Sorted Source Nodes: [x_3], Original ATen: [aten.convolution]
        stream0 = get_raw_stream(0)
        triton_poi_fused_convolution_2.run(buf38, buf49, 128, 32, stream=stream0)
        # Topologically Sorted Source Nodes: [x_3], Original ATen: [aten.convolution]
        buf50 = extern_kernels.convolution(buf49, arg38_1, stride=(1,), padding=(4,), dilation=(1,), transposed=False, output_padding=(0,), groups=128, bias=None)
        assert_size_stride(buf50, (1, 128, 32), (4096, 32, 1), 'torch.ops.aten.convolution.default')
        del arg38_1
        ...
        assert_size_stride(buf51, (1, 64, 32), (2048, 32, 1), 'torch.ops.aten.convolution.default')
        del arg39_1
        buf52 = reinterpret_tensor(buf39, (1, 32, 64), (2048, 64, 1), 0); del buf39  # reuse
        # Topologically Sorted Source Nodes: [conv_attn_layer_1], Original ATen: [aten.mul]
        stream0 = get_raw_stream(0)
        triton_poi_fused_mul_3.run(buf52, buf51, arg40_1, 32, 64, stream=stream0)
        del arg40_1
        del buf51
        ...
        extern_kernels.mm(reinterpret_tensor(buf52, (32, 64), (64, 1), 0), reinterpret_tensor(arg43_1, (64, 9), (1, 64), 0), out=buf53)
        del arg43_1
        del buf52
        ...
        stream0 = get_raw_stream(0)
        triton_poi_fused_im2col_5.run(buf48, arg46_1, buf56, 64, 288, stream=stream0)
        del arg46_1
        buf58 = reinterpret_tensor(buf48, (32, 64, 1), (64, 1, 1), 0); del buf48  # reuse
        ...
        extern_kernels.bmm(reinterpret_tensor(buf56, (32, 64, 9), (1, 288, 32), 0), buf57, out=buf58)
        del buf56
        del buf57
        buf59 = reinterpret_tensor(buf50, (1, 32, 2, 64), (4096, 128, 64, 1), 0); del buf50  # reuse
        # Topologically Sorted Source Nodes: [context_layer_6], Original ATen: [aten.cat]
        stream0 = get_raw_stream(0)
        triton_poi_fused_cat_6.run(buf44, buf58, buf59, 4096, stream=stream0)
        del buf44
        del buf58
        buf60 = reinterpret_tensor(buf49, (32, 128), (128, 1), 0); del buf49  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.addmm]
        extern_kernels.mm(reinterpret_tensor(buf59, (32, 128), (128, 1), 0), reinterpret_tensor(arg47_1, (128, 128), (1, 128), 0), out=buf60)
        del arg47_1
        del buf59
        buf64 = reinterpret_tensor(buf60, (1, 32, 128), (4096, 128, 1), 0); del buf60  # reuse
        # Topologically Sorted Source Nodes: [add_6, hidden_states_11], Original ATen: [aten.add, aten.native_layer_norm]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_native_layer_norm_7.run(buf64, arg48_1, buf38, arg49_1, arg50_1, 32, 128, stream=stream0)
        del arg48_1
        del arg49_1
        del arg50_1
        buf65 = reinterpret_tensor(buf33, (32, 256), (256, 1), 0); del buf33  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.addmm]
        extern_kernels.mm(reinterpret_tensor(buf64, (32, 128), (128, 1), 0), reinterpret_tensor(arg51_1, (128, 256), (1, 128), 0), out=buf65)
        del arg51_1
        buf66 = reinterpret_tensor(buf65, (1, 32, 256), (8192, 256, 1), 0); del buf65  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_13], Original ATen: [aten.gelu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_gelu_8.run(buf66, arg52_1, 8192, stream=stream0)
        del arg52_1
        buf67 = reinterpret_tensor(buf38, (32, 128), (128, 1), 0); del buf38  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.addmm]
        extern_kernels.mm(reinterpret_tensor(buf66, (32, 256), (256, 1), 0), reinterpret_tensor(arg53_1, (256, 128), (1, 256), 0), out=buf67)
        del arg53_1
        del buf66
        buf71 = reinterpret_tensor(buf67, (1, 32, 128), (4096, 128, 1), 0); del buf67  # reuse
        # Topologically Sorted Source Nodes: [add_7, hidden_states_16], Original ATen: [aten.add, aten.native_layer_norm]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_native_layer_norm_7.run(buf71, arg54_1, buf64, arg55_1, arg56_1, 32, 128, stream=stream0)
        del arg54_1
        del arg55_1
        del arg56_1
        del buf64
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg9_1 = rand_strided((128, 768), (768, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg15_1 = rand_strided((128, 1, 9), (9, 9, 1), device='cuda:0', dtype=torch.float32)
    arg16_1 = rand_strided((64, 128, 1), (128, 1, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg20_1 = rand_strided((9, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg38_1 = rand_strided((128, 1, 9), (9, 9, 1), device='cuda:0', dtype=torch.float32)
    arg39_1 = rand_strided((64, 128, 1), (128, 1, 1), device='cuda:0', dtype=torch.float32)
    arg40_1 = rand_strided((64, 1), (1, 1), device='cuda:0', dtype=torch.float32)
    arg41_1 = rand_strided((64, 128), (128, 1), device='cuda:0', dtype=torch.float32)
    arg42_1 = rand_strided((64, ), (1, ), device='cuda:0', dtype=torch.float32)
    arg43_1 = rand_strided((9, 64), (64, 1), device='cuda:0', dtype=torch.float32)
    ...
    arg51_1 = rand_strided((256, 128), (128, 1), device='cuda:0', dtype=torch.float32)
