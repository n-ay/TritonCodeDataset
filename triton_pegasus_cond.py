# Triton kernels for Pegasus_Cond
# Model: google/pegasus-xsum

triton_per_fused_add_arange_embedding_mul_native_layer_norm_0 = async_compile.triton('triton_per_fused_add_arange_embedding_mul_native_layer_norm_0', '''
import triton
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_arange_embedding_mul_native_layer_norm_0', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 4, 'num_reduction': 4, 'backend_hash': 'D8652C598408CE48EF7F8CD5982693EC810713EFE0D363B5F98854BFCB8CCE70', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_per_fused_add_arange_embedding_mul_native_layer_norm_0(in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, out_ptr2, xnumel, r0_numel, XBLOCK : tl.constexpr):
    xnumel = 32
    r0_numel = 64
    ...
    tmp9 = tl.load(in_ptr2 + (r0_1 + 64*x0), xmask, other=0.0)
...
triton_per_fused_add_arange_embedding_mul_native_layer_norm_2 = async_compile.triton('triton_per_fused_add_arange_embedding_mul_native_layer_norm_2', '''
import triton
import triton.language as tl
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_arange_embedding_mul_native_layer_norm_2', 'mutated_arg_names': ['in_out_ptr0'], 'optimize_mem': True, 'no_x_dim': False, 'num_load': 6, 'num_reduction': 4, 'backend_hash': 'D8652C598408CE48EF7F8CD5982693EC810713EFE0D363B5F98854BFCB8CCE70', 'are_deterministic_algorithms_enabled': False, 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False}
)
@triton.jit
def triton_per_fused_add_arange_embedding_mul_native_layer_norm_2(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, in_ptr4, in_ptr5, out_ptr2, xnumel, r0_numel, XBLOCK : tl.constexpr):
    xnumel = 32
    r0_numel = 64
    R0_BLOCK: tl.constexpr = 64
    rnumel = r0_numel
...
@triton.jit
def triton_per_fused_add_native_layer_norm_4(in_out_ptr0, in_ptr0, in_ptr1, in_ptr2, in_ptr3, xnumel, r0_numel, XBLOCK : tl.constexpr):
    xnumel = 32
    r0_numel = 64
    R0_BLOCK: tl.constexpr = 64
    rnumel = r0_numel
...
# kernel path: /tmp/torchinductor_root/ux/cuxghcfwfbz6rgnwrfiux2ht4ayp4yxphkeuyhpidzv7dr5fuckr.py
# Topologically Sorted Source Nodes: [embedding, inputs_embeds, position_ids, embed_pos, hidden_states, hidden_states_4, hidden_states_5], Original ATen: [aten.embedding, aten.mul, aten.arange, aten.add, aten.native_layer_norm]
# Source node to ATen node mapping:
...
#   %add_3 : [num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add, %view_12), kwargs = {})
...
#   %add_5 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_4, %arg15_1), kwargs = {})
triton_per_fused_add_arange_embedding_mul_native_layer_norm_2 = async_compile.triton('triton_per_fused_add_arange_embedding_mul_native_layer_norm_2', '''
import triton
import triton.language as tl
...
# kernel path: /tmp/torchinductor_root/34/c34z72hfg27vbqxgld4gji676xo42ygohtfkcvufsczahxohhxh2.py
...
# kernel path: /tmp/torchinductor_root/hi/chi4iwoanzupiykbd4uoemppsavbvrzj37qowlrlws5gkwhkoyqu.py
# Topologically Sorted Source Nodes: [hidden_states_10, hidden_states_11], Original ATen: [aten.add, aten.native_layer_norm]
# Source node to ATen node mapping:
#   hidden_states_10 => add_6
#   hidden_states_11 => add_7, add_8, mul_5, mul_6, rsqrt_2, sub_3, var_mean_2
# Graph fragment:
#   %add_6 : [num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_3, %view_16), kwargs = {})
...
#   %mul_6 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_5, %arg20_1), kwargs = {})
#   %add_8 : [num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_6, %arg21_1), kwargs = {})
triton_per_fused_add_native_layer_norm_4 = async_compile.triton('triton_per_fused_add_native_layer_norm_4', '''
import triton
import triton.language as tl
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        # Topologically Sorted Source Nodes: [embedding, inputs_embeds, position_ids, embed_pos, hidden_states, hidden_states_2], Original ATen: [aten.embedding, aten.mul, aten.arange, aten.add, aten.native_layer_norm]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_arange_embedding_mul_native_layer_norm_0.run(arg0_1, arg1_1, arg2_1, arg4_1, arg5_1, buf3, 32, 64, stream=stream0)
        del arg4_1
        del arg5_1
        buf4 = empty_strided_cuda((32, 64), (64, 1), torch.float32)
        # Topologically Sorted Source Nodes: [linear], Original ATen: [aten.addmm]
        extern_kernels.addmm(arg7_1, reinterpret_tensor(buf3, (32, 64), (64, 1), 0), reinterpret_tensor(arg6_1, (64, 64), (1, 64), 0), alpha=1, beta=1, out=buf4)
        del arg6_1
        del arg7_1
        ...
        extern_kernels.addmm(arg11_1, reinterpret_tensor(buf3, (32, 64), (64, 1), 0), reinterpret_tensor(arg10_1, (64, 64), (1, 64), 0), alpha=1, beta=1, out=buf6)
        del arg10_1
        del arg11_1
        del buf3
        buf7 = empty_strided_cuda((1, 1, 32, 32), (1024, 0, 32, 1), torch.float32)
        # Topologically Sorted Source Nodes: [attn_output], Original ATen: [aten._scaled_dot_product_efficient_attention]
        stream0 = get_raw_stream(0)
        triton_poi_fused__scaled_dot_product_efficient_attention_1.run(arg3_1, buf7, 1024, stream=stream0)
        del arg3_1
        # Topologically Sorted Source Nodes: [attn_output], Original ATen: [aten._scaled_dot_product_efficient_attention]
        buf8 = torch.ops.aten._scaled_dot_product_efficient_attention.default(reinterpret_tensor(buf4, (1, 2, 32, 32), (2048, 32, 64, 1), 0), reinterpret_tensor(buf5, (1, 2, 32, 32), (2048, 32, 64, 1), 0), reinterpret_tensor(buf6, (1, 2, 32, 32), (2048, 32, 64, 1), 0), reinterpret_tensor(buf7, (1, 2, 32, 32), (1024, 0, 32, 1), 0), False, scale=0.1767766952966369)
        del buf4
        del buf5
        del buf7
        buf9 = buf8[0]
        assert_size_stride(buf9, (1, 2, 32, 32), (2048, 32, 64, 1), 'torch.ops.aten._scaled_dot_product_efficient_attention.default')
        ...
        extern_kernels.mm(reinterpret_tensor(buf9, (32, 64), (64, 1), 0), reinterpret_tensor(arg12_1, (64, 64), (1, 64), 0), out=buf13)
        del arg12_1
        buf14 = reinterpret_tensor(buf13, (1, 32, 64), (2048, 64, 1), 0); del buf13  # reuse
        buf18 = reinterpret_tensor(buf9, (1, 32, 64), (2048, 64, 1), 0); del buf9  # reuse
        # Topologically Sorted Source Nodes: [embedding, inputs_embeds, position_ids, embed_pos, hidden_states, hidden_states_4, hidden_states_5], Original ATen: [aten.embedding, aten.mul, aten.arange, aten.add, aten.native_layer_norm]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_arange_embedding_mul_native_layer_norm_2.run(buf14, arg0_1, arg1_1, arg2_1, arg13_1, arg14_1, arg15_1, buf18, 32, 64, stream=stream0)
        del arg0_1
        del arg13_1
        del arg14_1
        del arg15_1
        del arg1_1
        del arg2_1
        buf19 = empty_strided_cuda((32, 4096), (4096, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.addmm]
        extern_kernels.mm(reinterpret_tensor(buf18, (32, 64), (64, 1), 0), reinterpret_tensor(arg16_1, (64, 4096), (1, 64), 0), out=buf19)
        del arg16_1
        buf20 = reinterpret_tensor(buf19, (1, 32, 4096), (131072, 4096, 1), 0); del buf19  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_6], Original ATen: [aten.relu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_relu_3.run(buf20, arg17_1, 131072, stream=stream0)
        del arg17_1
        buf21 = reinterpret_tensor(buf18, (32, 64), (64, 1), 0); del buf18  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.addmm]
        extern_kernels.mm(reinterpret_tensor(buf20, (32, 4096), (4096, 1), 0), reinterpret_tensor(arg18_1, (4096, 64), (1, 4096), 0), out=buf21)
        del arg18_1
        del buf20
        buf25 = buf14; del buf14  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_10, hidden_states_11], Original ATen: [aten.add, aten.native_layer_norm]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_native_layer_norm_4.run(buf25, buf21, arg19_1, arg20_1, arg21_1, 32, 64, stream=stream0)
        del arg19_1
        del arg20_1
        del arg21_1
        del buf21
