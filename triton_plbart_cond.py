# Triton kernels for PLBart_Cond
...
#   hidden_states_5 => add_5, add_6, mul_3, mul_4, rsqrt_1, sub_2, var_mean_1
# Graph fragment:
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_per_fused_add_embedding_mul_native_layer_norm_0.run(arg0_1, arg1_1, arg2_1, arg3_1, arg4_1, buf3, 32, 64, stream=stream0)
        del arg0_1
        del arg1_1
        del arg2_1
        del arg3_1
        ...
        # Topologically Sorted Source Nodes: [attn_output], Original ATen: [aten._scaled_dot_product_efficient_attention]
        stream0 = get_raw_stream(0)
        triton_poi_fused__scaled_dot_product_efficient_attention_1.run(arg5_1, buf7, 1024, stream=stream0)
        del arg5_1
        # Topologically Sorted Source Nodes: [attn_output], Original ATen: [aten._scaled_dot_product_efficient_attention]
        ...
        # Topologically Sorted Source Nodes: [hidden_states_4, hidden_states_5], Original ATen: [aten.add, aten.native_layer_norm]
        stream0 = get_raw_stream(0)
        triton_per_fused_add_native_layer_norm_2.run(buf17, buf13, arg13_1, arg14_1, arg15_1, 32, 64, stream=stream0)
        del arg13_1
        del arg14_1
        del arg15_1
        buf18 = empty_strided_cuda((32, 128), (128, 1), torch.float32)
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.addmm]
        extern_kernels.mm(reinterpret_tensor(buf17, (32, 64), (64, 1), 0), reinterpret_tensor(arg16_1, (64, 128), (1, 64), 0), out=buf18)
        del arg16_1
        buf19 = reinterpret_tensor(buf18, (1, 32, 128), (4096, 128, 1), 0); del buf18  # reuse
        # Topologically Sorted Source Nodes: [hidden_states_6], Original ATen: [aten.gelu]
        stream0 = get_raw_stream(0)
        triton_poi_fused_gelu_3.run(buf19, arg17_1, 4096, stream=stream0)
        del arg17_1
        buf20 = buf13; del buf13  # reuse
        # Topologically Sorted Source Nodes: [], Original ATen: [aten.addmm]
        extern_kernels.mm(reinterpret_tensor(buf19, (32, 128), (128, 1), 0), reinterpret_tensor(arg18_1, (128, 64), (1, 128), 0), out=buf20)
        del arg18_1
        del buf19
        ...
        stream0 = get_raw_stream(0)
        triton_per_fused_add_native_layer_norm_2.run(buf24, buf20, arg19_1, arg20_1, arg21_1, 32, 64, stream=stream0)
        del arg19_1
        del arg20_1
        del arg21_1
        del buf20
